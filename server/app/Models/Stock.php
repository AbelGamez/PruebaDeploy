...
class Stock extends Model {
     ...
     * 
     */
    public static function getProductsByCategoryInStockJoin ($category, $page = 1, $forPage = 2) {
     ...
     * 
     */
    public static function getProductsInStockFiltered($min_price, $max_price, $min_float, $max_float, $name, $stattrak = null, $page = 1, $forPage = 5) {
        // Inner Join entre la tabla "stocks" y "productos" mediante las columnas "product_id" y "id".
